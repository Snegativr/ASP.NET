...
var ErrorLogsFilePath = Path.Combine(Directory.GetCurrentDirectory(), "new/ErrorsLogs.txt");
app.UseDeveloperExceptionPage();

app.Map("/", (context) =>
{
    var htmlFilePath = Path.Combine(Directory.GetCurrentDirectory(), "new/index.html");
