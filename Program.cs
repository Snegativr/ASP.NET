...
builder.Configuration.AddJsonFile("new/Books.json");

var app = builder.Build();
var configuration = app.Services.GetService<IConfiguration>();
var jsonFilePath = Path.Combine(Directory.GetCurrentDirectory(), "new/users");
...
app.Map("/Library/Profile/{id:int?}", (int? id) =>
{
    ...
    {
        var configFileName = $"new/users/user{id}.json";
